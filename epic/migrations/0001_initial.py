# Generated by Django 3.1.3 on 2020-11-19 05:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('daily', 'daily'), ('weekly', 'weekly'), ('lootbox', 'lootbox'), ('vote', 'vote'), ('hunt', 'hunt'), ('adventure', 'adventure'), ('training', 'training'), ('duel', 'duel'), ('work', 'work'), ('horse', 'horse'), ('arena', 'arena'), ('dungeon', 'dungeon')], max_length=10)),
