# Generated by Django 3.1.3 on 2020-11-20 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('daily', 'daily'), ('weekly', 'weekly'), ('lootbox', 'lootbox'), ('vote', 'vote'), ('hunt', 'hunt'), ('adventure', 'adventure'), ('training', 'training'), ('duel', 'duel'), ('mine', 'work'), ('horse', 'horse'), ('arena', 'arena'), ('dungeon', 'dungeon')], max_length=10)),
